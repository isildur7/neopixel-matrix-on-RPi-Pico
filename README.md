...
We will be communicating with our matrix using serial commands. For this section, refer to the file neopixel-pico-comms.py. We will be using the serial monitor from the Arduino IDE so make sure you have Arduino IDE installed. Now, save the file neopixel-pico-comms.py as main.py on your Pico so it starts running when you connect your Pico to power.
